/**
 * @file test_os_task_create_static_finite_with_const_param.cpp
 * @author TheSomeMan
 * @date 2020-12-08
...
TEST_F(TestOsTask, os_task_create_static_finite_with_const_param_ok) // NOLINT
{
...
TEST_F(TestOsTask, os_task_create_static_finite_with_const_param_fail) // NOLINT
{
    const char *             task_name   = "my_task_name2";
    ...
    ASSERT_FALSE(os_task_create_static_finite_with_const_param(
        &task_func,
        task_name,
        &this->stack_mem[0],
        stack_depth,
