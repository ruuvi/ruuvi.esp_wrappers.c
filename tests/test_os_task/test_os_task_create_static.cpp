/**
 * @file test_os_task_create_static.cpp
 * @author TheSomeMan
 * @date 2020-12-08
...
TEST_F(TestOsTask, os_task_create_static_ok) // NOLINT
{
...
TEST_F(TestOsTask, os_task_create_static_fail) // NOLINT
{
    const char *             task_name   = "my_task_name2";
    ...
    ASSERT_FALSE(os_task_create_static(
        &task_func,
        task_name,
        &this->stack_mem[0],
        stack_depth,
